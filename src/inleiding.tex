...
In Figuur~\ref{fig:uniprot_aminozuur} en~\ref{fig:uniprot_length} bevatten een gedetailleerder overzicht van de aminozuurdistributie en verdeling van de proteïnelengtes.

\begin{figure}[h]
    \centering
    \includegraphics[width=0.6\linewidth]{uniprotKB_aminozuur_voorkomens}
    \caption{Aantal voorkomens per aminozuur voor alle proteïnen in de UniProtKB databank uit UniProt 2023\_04.}
...
\begin{figure}[h]
    ...
    \caption{Lengtedistributie van de proteïnen in de UniProtKB databank. De kleinere grafiek bevat een gedetailleerder overzicht van de distributie in het interval $[0, 1000[$.}\label{fig:uniprot_length}
\end{figure}
...
Met andere woorden: Swiss-Prot en Human-Prot zijn een representatieve kleinere voorstelling van UniProtKB\@.

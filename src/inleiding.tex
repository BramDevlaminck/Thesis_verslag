...
\begin{table}[h]
    ...
    \begin{tabular}{l l}
        ...
        \hline
    \end{tabular}
    \caption{Eigenschappen van de Swiss-Prot databank (UniProt 2023\_04). De afkorting \textit{aa} staat voor \textit{amino acids}.}
...
\begin{table}[ht]
    ...
    \begin{tabular}{ l l }
        ...
        \hline
    \end{tabular}
    \caption{Eigenschappen van de Human-Prot databank (UniProt 2023\_04). De afkorting \textit{aa} staat voor \textit{amino acids}.}
...
Een eerste optie is gebruik makende van andere servers van Unipept.
Zo is het mogelijk om applicaties die op dit moment op verschillend servers runnen tijdelijk zo te herverdelen dat er een machine met 768 GiB ram ter beschikking komt.
Een andere optie is door gebruik tee maken van de HPC van UGentV\footnote{\url{https://docs.hpc.ugent.be/}}.

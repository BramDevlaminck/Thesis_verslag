...
\paragraph{Swiss-Prot} Deze databank is één van de twee standaard onderdelen van UniProtKB\@.
...
Een andere optie is door gebruik tee maken van de HPC van UGent\footnote{\url{https://docs.hpc.ugent.be/}}.
...
\begin{table}[ht]
    ...
    \begin{tabular}{p{0.20\linewidth}p{0.45\linewidth}p{0.25\linewidth}}
        ...
        RAM               & 768 GiB                                                                   & 128 GiB              \\
        Opslag            & 6x 16 TiB HDD (3.5 inch, 7.2K RPM SATA), 4x 3.84 TiB SSD (2.5 inch, SATA) & 1 TiB SSD, 4 TiB SSD \\

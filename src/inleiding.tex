...
\begin{itemize}
    ...
    \item \textbf{Unipept API~\cite{unipept_api, unipept_cli}} Dit is een collectie van \textit{endpoints} die andere applicaties, inclusief de CLI, toelaat om de functionaliteit van Unipept te integreren. % TODO: Peter heeft de "inclusief cli" als opmerking toegevoegd, maar wat wou hij precies?

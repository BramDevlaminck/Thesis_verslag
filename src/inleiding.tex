...
Het transcriptoom ook een belangrijke indicatie van welke onderdelen van het DNA effectief proteïnen encoderen.
...
\begin{figure}[H]
    ...
    \caption{Voorbeeld van de werking van trypsine op 2 proteïnen. De aminozuren in het rood zijn lysine (K) of arginine (R), waarna trypsine knipt (behalve als het eerstvolgende aminzoruur proline (P) is). Bij de tweede proteïne is er geen knip na het tweede voorkomen van lysine omdat die gevolgd wordt door proline~\cite{phdPieterUnipept}.}
    \label{fig:trypsine}
\end{figure}
...
Dit verklaart dan ook de nood voor een nieuwe indexstructuur die toe laat volledig willekeurig gesplitste peptiden te zoeken.
\newline

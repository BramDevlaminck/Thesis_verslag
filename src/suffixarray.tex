...
In Figuur~\ref{fig:search_sparseness}~(b) is duidelijk te zien dat, voor dit geval, de overgang van sparseness factor 4 naar 5 erg weinig winst heeft qua opslagruimte, maar een grote impact heeft op de performantie. % TODO: vraag peter over een woord bij de "vrije opslagruimte"
\\ \\
...
\begin{enumerate}
    ...
    Hierbij kan gebruikgemaakt worden van het feit dat het binair zoeken naar een I en L hetzelfde patroon af legt tenzij bij een I, J, K of L\@.

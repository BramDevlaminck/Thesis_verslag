...
% TODO: add example of searching with skipping x characters
...
Deze traits worden door het typesysteem automatisch afgeleid als alle onderdelen van je type aan de \texttt{Sync} en \texttt{Send} trait voldoen, dan voldoet je nieuwe type ook automatisch. % TODO: vermelden dat er een erg kleine aanpassing in umgap nodig is geweest of niet?
\\ \\

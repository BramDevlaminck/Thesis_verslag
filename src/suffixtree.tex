...
Wat op zich veel goede informatie heeft, maar naar mijn ervaring soms te veel details bevat.
Een veelvoorkomend patroon in het boek is dat een deel van een concept geïntroduceerd wordt, waarna je als lezer geïnformeerd wordt dat je er op dat moment nog niet over moet denken omdat dat er in een later hoofdstuk een uitgebreidere uitleg volgt.
Dit zorgt ervoor dat het soms moeilijk is de bomen door het bos te zien.
Een voorbeeld hiervan zijn de verschillende syntaxen die Rust aanbiedt om soms hetzelfde te doen, dit maakt het als lezer moeilijker om te focussen op de essentiële delen.
\\ \\
...
Dit zijn een reeks aan erg kleine oefeningen die meestal in maximaal enkele minuten gemaakt zijn, maar ervoor zorgen dat je toch al eens in contact komt met alle basisonderdelen van Rust.

...
\begin{figure}[H]
    \centering
    \subfloat[Tijd nodig om de boom op te bouwen]{\includegraphics[width=\linewidth]{building_tree_time}}\\[4ex] % [4ex] om wat extra vertical spacing in te voegen

    \subfloat[Maximaal gebruikt geheugen tijdens het opbouwen van de boom]{\includegraphics[width=\linewidth]{building_tree_memory}}
...
Dit kan bv een achtergrond proces zijn, maar ook invloed van een andere VM die op de fysieke machine bezig is (wat hier het geval is, aangezien Stijn Declercq ook een VM op \textit{Matty} gebruikt voor zijn testen).

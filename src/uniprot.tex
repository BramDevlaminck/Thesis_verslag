...
Na het gebruik van deze bibliotheek resulteert dit in \textbf{11 GB extra geheugengebruik}, wat in de context van de al 320 GB grote index (wanneer de tekst ook meegerekend wordt) bijna verwaarloosbaar is.
...
Eens de HPC klaar is met het bouwen van de index moet de resulterende SSA van ongeveer 240 GB verplaatst worden naar alle Unipept servers die de index zullen hosten.

...
\begin{figure}[H]
    \centering
    \subfloat[Zoektijd voor het Swiss-Prot peptidebestand met en zonder \textit{missed cleavages}. De zoekoperaties zijn uitgevoerd op een sparse suffix array gebouwd op basis van de Swiss-Prot proteïnedatabank, met $k = 1, 2, 3, 4, 5$.]{\includegraphics[width=0.88\linewidth]{swissprot_searchtime_sparseness}}\\[4ex] % [4ex] om wat extra vertical spacing in te voegen
...
Zo matchen slechts $\pm$ 13\thinspace000 van de 1.3 miljard tryptische peptiden met meer dan 10\thinspace000 proteïnen.

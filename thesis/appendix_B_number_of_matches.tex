...
\begin{table}[h!]
    ...
    \begin{tabular}{|l|r|}
        ...
        forma & 0 \\ \hline
    \end{tabular}
    \caption{Overzicht van de resulterende LCA voor de 13\thinspace008 verschillende peptiden uit tabel~\ref{tab:number_peptide_matches} die met meer dan $10^4$ proteïnen matchen. Voor de overgrote meerderheid is de resulterende LCA de root. Slechts voor 200 peptiden is het resultaat op soortniveau.}

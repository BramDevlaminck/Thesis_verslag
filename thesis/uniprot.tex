...
\begin{figure}[h]
    ...
    Naast de twee onderdelen die nodig zijn voor het matchen van de suffixen, is er nog een kleine 25 GB extra geheugenverbruik voor het uitvoeren van de Unipept analyses, of om de ID's van de gevonden matches terug te kunnen geven.}
    ...
    \begin{minted}[frame=lines,framesep=2mm,linenos]{JSON}
{
  "result": [
    ...
    Peptides zonder match worden dus simpelweg weggelaten in de output.

...
% TODO: tekstje over het feit dat dit nog wat extra overhead introduceert op vlak van uitvoeringstijd. En geef hier ook een grafiek, mogelijks vergelijking met de originele Unipept als performantie conclusie?
...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.85\linewidth]{uniprot_memory_treemap}
